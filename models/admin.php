...
class Admin
{
  ...
  public function lapDataPengunjung($aktivitas)
  {
    $db = $this->mysqli->conn;
    $query = $db->query("SELECT * FROM pengunjung WHERE aktivitas = '$aktivitas'");
    return $query;
  }
  ...
  public function dataPengunjungMembaca()
  {
    $db = $this->mysqli->conn;
    $query = $db->query("SELECT * FROM pengunjung WHERE aktivitas = 'Pinjam' ");
    return $query;
  }
  ...
  public function dataPengunjungBulanMHS()
  {
    $date =  date('Y-m-d');
    $db = $this->mysqli->conn;
    $query = $db->query("SELECT * FROM pengunjung WHERE kategori = '1' ");
    return $query;
  }
